...
export interface SportzButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-transparent text-foreground border-border hover:bg-muted font-medium',
  ghost:
  ...
  danger: 'bg-red-500 text-white border-transparent hover:bg-red-600 font-semibold shadow-sm',
}
...
export const SportzButton = forwardRef<HTMLButtonElement, SportzButtonProps>(function SportzButton(
  {
    variant = 'secondary',
    size = 'md',
    isLoading = false,
